...
public class PlacableObjectsManager : MonoBehaviour
{
    ...
    private void Start()
    {
        GameManager.instance.GetComponent<PlaceableObjectsReferenceManager>().placableObjectsManager = this;
        VisualizeMap();
    }
    ...
    {
        GameObject go = Instantiate(placeableObject.placedItem.itemPrrefab);
